...
export default function Home() {
  ...
  return (
    <div className={`min-h-screen bg-[#f5f5f7] dark:bg-neutral-900 font-sans antialiased text-[#1d1d1f] dark:text-neutral-100 ${theme === 'dark' ? 'dark' : ''}`}>
      ...
      {loading ? (
        <div className="px-4 py-8 mx-auto max-w-5xl space-y-6 animate-pulse mt-2 dark:opacity-50">
          {/* Header Placeholder */}
